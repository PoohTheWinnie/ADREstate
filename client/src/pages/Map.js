...
import { registerHouse, getHouses, updateHouse } from '../actions/houseActions';
...
class MyMap extends Component{
    ...
    handleSubmit(e){
        ...
        const userId = this.props.user.user.id;
        this.props.registerHouse({strAdd, lat, lng, pictureLink, bedrooms, bathrooms, squareFeet, description, userId});
        this.setState({
            modalOpen: false,
        });
    }
                            ...
                            <Marker key={`marker-${idx}`} position={{ lat: house.latitude, lng: house.longitude }} icon={ customIcon }>
                                <Popup>
                                    <div style={popupContent}>
                                        {house.status ? (
                                            <div>
                                                <img src="https://cdn3.iconfinder.com/data/icons/basicolor-arrows-checks/24/149_check_ok-512.png" width="150" height="150"/>
                                        ...
                                        <div className="moreInfoButton">
                                            {this.state.getMoreInfo ? 
                                                ...
                                                (<Button value={house} onClick={() => this.setState( {getMoreInfo: true, currHouse: house })}>Get More Info</Button>)
                                            }
                                        </div>
                                    </div>
                                </Popup>
...
export default connect(mapStateToProps, { registerHouse, getHouses, updateHouse, clearErrors })(MyMap);